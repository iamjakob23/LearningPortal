...
<html>
    <head>
        ...
        <title>Knowledge IS Power - Math | Hardest Subtraction</title>
                    ...
                    <div class="leftContainer">
                        ...
                        <script>
                            ...
                            document.write('<div class="col-md-6" id="rightcolumn">');
                                ...
                                document.writeln("<div class='incorrect'>Incorrect: " + wrongAnswer + "</div>");
                                
                                //hidden form that allows user scores to be entered into database
                                document.write('<form method="post" action="math-hardest-sub.php" id="scoring">');
